...
const HowItWorks = () => {
  return (
    <section className="py-12 md:py-20">
      <div className="bg-white rounded-[2rem] p-6 md:p-16 text-center shadow-[0_20px_60px_rgba(0,0,0,0.04),0_0_0_1px_rgba(0,0,0,0.02)]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 text-left">
          {howItWorks.steps.map((step) => (
            <div key={step.id} className="flex-1 bg-slate-50 p-6 md:p-8 rounded-3xl border border-slate-100 w-full">
